  ...
  return <ResponsiveLayout>
    ...
    <Card className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-[#0a0a0f] dark:to-[#1a1a1a] border border-gray-200 dark:border-gray-800 overflow-hidden"><div className="p-6 md:p-8">
      <div className="flex items-center justify-between mb-6">
        <div className="flex flex-col items-center"><div className="w-14 h-14 md:w-16 md:h-16 rounded-full overflow-hidden mb-2"><PlayerAvatar avatar={homePlayer.avatar ?? "?"} /></div><div className="text-xs text-gray-600 dark:text-gray-400 font-medium">{homePlayer.username}</div>{hasAuthoritativePositions && <div className="text-[10px] font-semibold uppercase tracking-wider text-blue-500 mt-1">Home</div>}</div>
        ...
        <div className="flex flex-col items-center"><div className="w-14 h-14 md:w-16 md:h-16 rounded-full overflow-hidden mb-2"><PlayerAvatar avatar={awayPlayer.avatar ?? "?"} /></div><div className="text-xs text-gray-600 dark:text-gray-400 font-medium">{awayPlayer.username}</div>{hasAuthoritativePositions && <div className="text-[10px] font-semibold uppercase tracking-wider text-red-500 mt-1">Away</div>}</div>
      </div>
